        ...
        <article class="col-8 offset-2">
          ...
          <section class="mb-5">
            ...
            <p class="fs-5">
              ...
              information. This Privacy Policy explains in detail how we
              collect, use, disclose, and safeguard your data when you use our
              web application ("the Service") for managing personal to-do lists.
          ...
          <section class="mb-5">
            ...
            <p class="fs-5">
              ...
              improving our to-do list management service. Specifically, we use
              your data for:
            </p>
          ...
          <section class="mb-5">
            ...
            <p class="fs-5">
              We are committed to protecting your data and have implemented the
              following measures:
            </p>
            ...
            <ul>
              <li class="fs-5">
                ...
                users or our staff, except when necessary for technical support
            ...
            <ul>
              <li class="fs-5">
                We use industry-standard encryption protocols (such as SSL/TLS)
          ...
          <section class="mb-5">
            ...
            <p class="fs-5">We use the following types of essential cookies:</p>
            <ul>
              <li class="fs-5">
            ...
            <p class="fs-5">
              ...
              settings preferences. However, limiting the ability of websites to
              set cookies may worsen your overall user experience and could
          ...
          <section class="mb-5">
            ...
            <ul>
              ...
              <li class="fs-5">
                Delete all your personal information and to-do list content from
                our active systems within 30 days
              </li>
              <li class="fs-5">
          ...
          <section class="mb-5">
            ...
            <ul>
              <li class="fs-5">Posting the new Privacy Policy on this page</li>
              <li class="fs-5">
          ...
          <section class="mb-5">
            ...
            <p class="fs-5">
              ...
              information, or our data practices, please contact us at:
            </p>
            <address>
