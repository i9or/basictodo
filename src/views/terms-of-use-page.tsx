      ...
      <div class="row">
        <article class="col-8 offset-2">
          ...
          <section class="mb-5">
            ...
            <p class="fs-5">
              4.1. You are responsible for all activities that occur under your
              account.
            </p>
            <p class="fs-5">
          ...
          <section class="mb-5">
            ...
            <p class="fs-5">
              7.1. Basic Productivity Ltd. shall not be liable for any indirect,
            ...
            <p class="fs-5">
              ...
              any third party, even if Basic Productivity Ltd. has been advised
          ...
          <section class="mb-5">
            ...
            <p class="fs-5">
              8.1. We reserve the right to modify or discontinue, temporarily or
          ...
          <section class="mb-5">
            ...
            <p class="fs-5">
              9.1. We may terminate or suspend your account immediately, without
